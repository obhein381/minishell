...
SRCS = srcs/debug/debug_token.c srcs/debug/debug_commands.c \
		...
		srcs/expander/expander.c srcs/expander/expander_opt.c \
		srcs/lexer/tokenization.c srcs/lexer/tokenization_opt.c \
		srcs/parser/heredoc.c srcs/parser/heredoc_opt.c  \
		...
		srcs/executor/builtin/execute_builtin.c srcs/executor/builtin/execute_builtin_opt.c\
		srcs/executor/builtin/execute_exit.c \
		srcs/executor/builtin/execute_pwd.c srcs/executor/builtin/execute_unset.c \
